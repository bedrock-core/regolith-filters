...
| Filter | Description |
|--------|-------------|
| [**core**](./core/README.md) | Runs the whole stack as one filter — manifest, guides, i18n, ui-compile, bundler (and the generator on request) — in the order they depend on, with `namespace` declared once. |
