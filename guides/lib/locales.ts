...
export function reconcileLocale(
  defaultLang: Map<string, string>,
  localeLang: Map<string, string>,
): { filled: Map<string, string>; missing: string[]; extra: string[] } {
 ...
 */
export function summarizeKeysByPage(keys: Iterable<string>, prefix: string): string[] {
