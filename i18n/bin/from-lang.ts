...
import { parseLang } from '../lib/lang.ts';
import { scanNamespace, walkSources } from '../lib/scan.ts';
...
function setPath(tree: Record<string, any>, dotPath: string, value: string): string | null {
...
function emitTree(node: Record<string, any>, indent: number): string {
