...
/** Bundle `absPath` through esbuild and import it; returns its default export. */
export async function loadTsModule(absPath: string, cacheDir: string): Promise<unknown> {
